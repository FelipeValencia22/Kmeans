...
public class AlgoKMeans {
	...
	public void printStatistics() {
		...
		System.out.println(" Funcion: " + distanceFunction.getName());
		System.out.println(" SSE (Sum of Squared Errors) : " + ClustersEvaluation.calculateSSE(clusters, distanceFunction));
		System.out.println(" Iteraciones: " + iterationCount);
		System.out.println("==============================");
	}
